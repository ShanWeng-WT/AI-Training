# 第 7 堂：從對話到行動：Agent 的本質與運作機制總結 - 講者筆記

## ⏳ 課程時間表 (總長：30 分鐘)

### [00:00 - 05:00] 回顧與破題 (5 min)
*   **Slide: 課程目標**
*   **講者動作：** 開場點明：我們上了 6 堂課，大家都在用 Agent，但它底層到底是什麼？
...
*   **口白：** 「前 7 堂課我們掌握了 Agent 個體與團隊的操作。從下一堂課（第 8 堂）開始，我們要進入『企業級架構』的領域，學習如何建立整個專案的大腦：AGENTS.md。」
